...
#[OA\Schema(
    schema: 'SpecialistInvestigationRequest',
    type: 'object',
    required: ['id', 'emergency_id', 'specialist_investigation_id', 'requested_by', 'status', 'requested_at', 'created_at', 'updated_at'],
    properties: [
        ...
        new OA\Property(property: 'requested_at', type: 'string', format: 'date-time', example: '2026-01-01T10:00:00Z'),
        ...
        new OA\Property(property: 'specialist_investigation', ref: '#/components/schemas/SpecialistInvestigation', nullable: true),
        new OA\Property(property: 'requester', ref: '#/components/schemas/UserSummary', nullable: true),
